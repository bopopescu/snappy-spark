 ...
 */
private[spark] class MultiColumnOpenHashSet[@specialized(Long, Int) T: ClassTag](
  initialCapacity: Int,
  loadFactor: Double)
...
private[spark] object MultiColumnOpenHashSet {
   ...
   * in the specialized implementation of MultiColumnOpenHashSet.
   */
